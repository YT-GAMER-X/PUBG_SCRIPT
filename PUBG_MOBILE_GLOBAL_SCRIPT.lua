...
if YT_GAMER_X[2] == true then MB() end
if YT_GAMER_X[3] == true then HM() end
if YT_GAMER_X[4] == true then NO() end
if YT_GAMER_X[5] == true then BP() end
if YT_GAMER_X[6] == true then EXIT() end
...
if YT_GAMER_X == nil then else
if YT_GAMER_X[1] == true then WH1() end
if YT_GAMER_X[2] == true then CH1() end
if YT_GAMER_X[3] == true then HOME() end
